...
def get_vehiclepositions_historylast() -> dict[int, list[VehiclePosition]] | None:
    with Session() as session:
        ...
        batch_snapshots = {}
        for vp in vehicles:
            if vp.timestamp_fetch not in batch_snapshots:
                batch_snapshots[vp.timestamp_fetch] = []
            batch_snapshots[vp.timestamp_fetch].append(vp)
